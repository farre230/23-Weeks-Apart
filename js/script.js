...
//         $('html, body').stop().animate({scrollTop: posToScroll}, 150); // automatically scrolls to next or previous panel based on the results of the previous line of code
//     });
// });